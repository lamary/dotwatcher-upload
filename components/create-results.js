...
class CreateResults extends Component {
  ...
  render() {
    ...
    const changingResults = <div><p className="f4 measure">Looks like there are published results for this race, you can add more with this form.</p><p className="f4 measure">But it’s more like that you're here to edit existing results:</p><ul className="f4"><li>Download CSV of results</li><li>Edit them and save a new csv file</li><li>Delete the old results using the button below</li><li>Upload new results</li><li>Check it all looks good</li><li>Click “save changes”</li></ul></div>
